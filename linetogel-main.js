...
+'/* ===== UNIQUE SPORT ARENA 2026 ===== */\n'
+':root{--arena-cyan:#19d8ff;--arena-blue:#0877ff;--arena-violet:#8d45ff;--arena-magenta:#ff2f97;--arena-gold:#ffd86b;--arena-green:#50f29a;--arena-panel:#071a2d;--arena-panel2:#0a233b;--arena-line:rgba(25,216,255,.28);}\n'
+'body{background:radial-gradient(circle at 50% -10%,rgba(9,112,255,.22),transparent 34%),radial-gradient(circle at 8% 20%,rgba(141,69,255,.16),transparent 28%),linear-gradient(180deg,#020812 0%,#030b15 46%,#02050a 100%)!important;}\n'
+'body::before{content:\"\";position:fixed;inset:0;pointer-events:none;z-index:-1;background-image:linear-gradient(rgba(25,216,255,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(25,216,255,.025) 1px,transparent 1px);background-size:46px 46px;mask-image:linear-gradient(to bottom,black,transparent 72%);}\n'
+'.stats-bar{display:none!important;}\n'
+'.site-logo.hero-arena{width:94%;height:clamp(180px,27vw,310px);max-height:none;margin:18px auto 8px!important;border:1px solid rgba(25,216,255,.5);border-radius:28px!important;position:relative;display:block!important;overflow:hidden;padding:0!important;background:radial-gradient(circle at 50% 105%,rgba(25,216,255,.24),transparent 32%),linear-gradient(90deg,rgba(4,23,40,.96),rgba(5,18,34,.86) 45%,rgba(4,22,39,.96)),linear-gradient(180deg,#08243f,#03101e)!important;box-shadow:0 22px 70px rgba(0,0,0,.58),0 0 0 1px rgba(255,255,255,.03) inset,0 0 40px rgba(25,216,255,.10)!important;isolation:isolate;}\n'
+'.hero-arena::before{content:\"\";position:absolute;left:-5%;right:-5%;bottom:-34%;height:70%;border-radius:50%;border-top:1px solid rgba(25,216,255,.42);background:repeating-linear-gradient(90deg,transparent 0 7%,rgba(25,216,255,.08) 7.2% 7.5%,transparent 7.7% 14%),repeating-linear-gradient(0deg,transparent 0 19%,rgba(25,216,255,.08) 19.3% 19.7%,transparent 20% 40%);transform:perspective(360px) rotateX(63deg);box-shadow:0 -28px 70px rgba(25,216,255,.12);z-index:-1;}\n'
+'.hero-arena::after{content:\"\";position:absolute;inset:0;pointer-events:none;background:linear-gradient(115deg,transparent 0 34%,rgba(255,255,255,.05) 42%,transparent 50% 100%);transform:translateX(-70%);animation:arenaSweep 7s ease-in-out infinite;z-index:4;}\n'
+'@keyframes arenaSweep{0%,40%{transform:translateX(-78%)}70%,100%{transform:translateX(78%)}}\n'
+'.hero-logo-zone{position:absolute;left:7%;top:50%;transform:translateY(-50%);width:35%;display:flex;align-items:center;justify-content:center;z-index:3;}\n'
+'.hero-arena .logo-main{width:min(100%,340px)!important;max-width:340px!important;filter:drop-shadow(0 6px 10px rgba(0,0,0,.65)) drop-shadow(0 0 18px rgba(255,216,107,.22))!important;}\n'
+'.hero-player-zone{position:absolute;left:50%;bottom:0;transform:translateX(-50%);height:94%;width:31%;display:flex;align-items:flex-end;justify-content:center;z-index:3;}\n'
+'.hero-arena .mbappe-gif{width:auto!important;height:86%!important;max-width:none!important;min-width:0!important;object-fit:contain!important;filter:drop-shadow(0 14px 18px rgba(0,0,0,.78)) drop-shadow(0 0 20px rgba(25,216,255,.18))!important;transform:none!important;cursor:default!important;}\n'
+'.hero-arena .mbappe-gif:hover{transform:translateY(-3px) scale(1.025)!important;filter:drop-shadow(0 18px 22px rgba(0,0,0,.8)) drop-shadow(0 0 28px rgba(25,216,255,.35))!important;}\n'
+'.player-halo{position:absolute;width:82%;aspect-ratio:1;border-radius:50%;bottom:3%;background:radial-gradient(circle,rgba(25,216,255,.27) 0,rgba(25,216,255,.08) 38%,transparent 68%);filter:blur(4px);animation:haloPulse 3.2s ease-in-out infinite;z-index:-1;}\n'
+'@keyframes haloPulse{0%,100%{transform:scale(.92);opacity:.65}50%{transform:scale(1.08);opacity:1}}\n'
+'.hero-light{position:absolute;top:-14%;width:20%;height:92%;background:linear-gradient(180deg,rgba(116,201,255,.35),rgba(25,216,255,.03) 62%,transparent);filter:blur(8px);transform-origin:top;opacity:.5;z-index:0;}\n'
+'.hero-light-a{left:3%;transform:rotate(16deg)}.hero-light-b{right:3%;transform:rotate(-16deg)}.hero-light-c{left:40%;width:20%;opacity:.24;}\n'
+'.hero-decor{position:absolute;right:7%;top:50%;transform:translateY(-50%);width:25%;display:grid;gap:10px;z-index:2;}\n'
+'.hero-decor span{display:block;height:5px;border-radius:99px;background:linear-gradient(90deg,transparent,rgba(25,216,255,.72),transparent);box-shadow:0 0 16px rgba(25,216,255,.28);}\n'
+'.hero-decor span:nth-child(2){width:72%;margin-left:auto}.hero-decor span:nth-child(3){width:44%;margin-left:auto;}\n'
+'.date-display{width:94%!important;min-height:54px;margin:0 auto 10px!important;padding:0 18px!important;border:1px solid rgba(25,216,255,.42)!important;border-radius:14px!important;background:linear-gradient(90deg,#06223a,#071729 42%,#061c31)!important;box-shadow:0 12px 30px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.04)!important;position:relative;overflow:hidden;}\n'
+'.date-display::before{content:\"JADWAL PERTANDINGAN\";font-size:9px;font-weight:900;letter-spacing:1.3px;color:#03101d;background:linear-gradient(180deg,#35e6ff,#0fa9ff);padding:6px 10px;border-radius:8px;box-shadow:0 0 18px rgba(25,216,255,.25);}\n'
+'.date-display::after{content:\"\";width:130px;height:1px;background:linear-gradient(90deg,rgba(255,216,107,.55),transparent);position:absolute;right:18px;}\n'
+'.date-text{font-family:\'Poppins\',sans-serif!important;font-size:clamp(11px,2vw,14px)!important;font-weight:800!important;color:#fff!important;text-shadow:none!important;letter-spacing:.2px!important;}\n'
+'.marquee-wrap{width:94%!important;margin:0 auto 14px!important;border:1px solid rgba(80,242,154,.4)!important;border-radius:14px!important;padding:0!important;height:44px!important;display:flex;align-items:center;background:linear-gradient(90deg,rgba(3,54,45,.82),rgba(6,26,39,.94) 28%,rgba(5,21,34,.94))!important;box-shadow:0 12px 30px rgba(0,0,0,.24)!important;}\n'
+'.marquee-wrap::before{content:\"INFO TERBARU\";display:flex;align-items:center;height:100%;padding:0 15px;color:#091816;background:linear-gradient(180deg,#54f5a4,#1ccf78);font-size:9px;font-weight:900;letter-spacing:1px;flex:0 0 auto;}\n'
+'.marquee-inner{font-size:11px!important;font-weight:700!important;color:#eaf7ff!important;text-shadow:none!important;letter-spacing:.2px!important;animation-duration:30s!important;}\n'
+'.bm-section{width:94%!important;margin:0 auto 16px!important;}\n'
+'.bm-head{text-align:left!important;margin:7px 0 12px!important;display:flex;align-items:center;gap:10px;}\n'
+'.bm-kicker{border:0!important;background:transparent!important;padding:0!important;border-radius:0!important;font-family:\'Poppins\',sans-serif!important;font-size:clamp(17px,2.2vw,25px)!important;font-style:italic;font-weight:900!important;color:#fff!important;text-shadow:0 0 18px rgba(141,69,255,.28)!important;letter-spacing:-.6px!important;}\n'
+'.bm-kicker::first-letter{color:var(--arena-gold)}\n'
+'.bm-runner{padding:0 1px 12px!important;}\n'
+'.bm-track{gap:14px!important;}\n'
+'.bm-card{width:320px!important;min-height:190px;border:1px solid rgba(25,216,255,.7)!important;border-radius:16px!important;padding:13px!important;background:radial-gradient(circle at 50% -20%,rgba(25,216,255,.16),transparent 55%),linear-gradient(145deg,#08243d,#06172a 60%,#06111f)!important;box-shadow:0 14px 34px rgba(0,0,0,.36),inset 0 1px 0 rgba(255,255,255,.06),0 0 20px rgba(25,216,255,.06)!important;}\n'
+'.bm-card:nth-child(4n+2){border-color:rgba(141,69,255,.78)!important;background:radial-gradient(circle at 50% -20%,rgba(141,69,255,.22),transparent 55%),linear-gradient(145deg,#1a113a,#0c1630 66%,#070e1b)!important;}\n'
+'.bm-card:nth-child(4n+3){border-color:rgba(255,47,151,.7)!important;background:radial-gradient(circle at 50% -20%,rgba(255,47,151,.20),transparent 55%),linear-gradient(145deg,#341029,#15132b 66%,#080f1c)!important;}\n'
+'.bm-card:hover{transform:translateY(-5px)!important;box-shadow:0 24px 42px rgba(0,0,0,.5),0 0 28px rgba(25,216,255,.16)!important;}\n'
+'.bm-badgewrap{justify-content:flex-start!important;margin:0 0 5px!important;}\n'
+'.bm-badgewrap::before,.bm-badgewrap::after{display:none!important;}\n'
+'.bm-badge{font-family:\'Poppins\',sans-serif!important;color:white!important;background:linear-gradient(90deg,#ee2b8c,#ff5ab1)!important;border:1px solid rgba(255,255,255,.18)!important;padding:5px 10px!important;font-size:8.5px!important;letter-spacing:.5px!important;box-shadow:0 0 16px rgba(255,47,151,.28)!important;}\n'
+'.bm-league{text-align:left!important;font-size:8px!important;letter-spacing:1.25px!important;color:#d3e7ff!important;opacity:.78!important;margin-bottom:9px!important;}\n'
+'.bm-teams{gap:8px!important;margin:3px 0 8px!important;}\n'
+'.bm-logo{width:54px!important;height:54px!important;border:1px solid rgba(25,216,255,.45)!important;background:rgba(1,10,20,.52)!important;box-shadow:0 0 18px rgba(25,216,255,.12),inset 0 0 16px rgba(0,0,0,.45)!important;}\n'
+'.bm-team b{font-family:\'Poppins\',sans-serif!important;font-size:11px!important;color:#fff!important;max-width:100px;}\n'
+'.bm-teams em{font-family:\'Cinzel\',serif!important;font-size:15px!important;color:white!important;opacity:1!important;text-shadow:0 0 14px rgba(25,216,255,.5);}\n'
+'.bm-meta{font-size:8.7px!important;color:#d9edff!important;opacity:.8!important;margin-bottom:9px!important;}\n'
+'.bm-values{background:rgba(1,9,17,.48);border:1px solid rgba(25,216,255,.12);border-radius:10px;padding:9px 5px 2px!important;border-top:1px solid rgba(25,216,255,.12)!important;}\n'
+'.bm-val i{font-size:7px!important;color:var(--arena-cyan)!important;opacity:.9!important;}\n'
+'.bm-val b{font-family:\'Poppins\',sans-serif!important;font-size:16px!important;color:#fff!important;text-shadow:none!important;}\n'
+'.filter-wrap{width:94%!important;margin:0 auto 12px!important;grid-template-columns:minmax(180px,34%) 1fr!important;gap:10px!important;}\n'
+'.filter-label{display:none!important;}\n'
+'.fselect,.fsearch{height:44px!important;border:1px solid rgba(25,216,255,.32)!important;border-radius:12px!important;background:#071a2b!important;color:#e9f7ff!important;font-family:\'Poppins\',sans-serif!important;font-size:10px!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.04)!important;}\n'
+'.fselect{color:var(--arena-cyan)!important;font-weight:800!important;}\n'
+'.select-box::after{color:var(--arena-cyan)!important;}\n'
+'.search-icon{left:14px!important;color:#65dfff!important;font-size:13px!important;}\n'
+'.fsearch{padding-left:38px!important;}\n'
+'.fsearch::placeholder{color:#7fa9c8!important;}\n'
+'.tap-hint{width:94%!important;margin:0 auto 14px!important;justify-content:flex-start!important;background:linear-gradient(90deg,rgba(255,216,107,.08),rgba(5,19,32,.8))!important;border:1px solid rgba(255,216,107,.22)!important;border-radius:12px!important;padding:11px 14px!important;}\n'
+'.hint-arrow:first-child{color:var(--arena-gold)!important}.hint-arrow:last-child{display:none!important}.hint-text{font-family:\'Poppins\',sans-serif!important;font-size:10px!important;color:#eef7ff!important;opacity:.88!important;letter-spacing:0!important;}\n'
+'.league-block{width:94%!important;margin:0 auto 18px!important;padding:0!important;border:1px solid rgba(25,216,255,.28)!important;border-radius:16px!important;background:linear-gradient(180deg,rgba(6,27,45,.92),rgba(3,13,24,.95))!important;box-shadow:0 18px 44px rgba(0,0,0,.34),inset 0 1px 0 rgba(255,255,255,.04)!important;overflow:hidden;}\n'
+'.league-inner{border:0!important;border-radius:0!important;}\n'
+'.league-crown{min-height:58px;justify-content:flex-start!important;padding:11px 18px!important;background:linear-gradient(90deg,#0b3c70,#0a2545 55%,#07172a)!important;border:0!important;border-bottom:1px solid rgba(25,216,255,.18)!important;}\n'
+'.league-crown::after{animation-duration:5s!important;opacity:.32;}\n'
+'.crown-name{font-family:\'Poppins\',sans-serif!important;font-size:clamp(12px,1.5vw,16px)!important;color:white!important;text-align:left!important;letter-spacing:.5px!important;}\n'
+'.match-count{right:15px!important;background:rgba(25,216,255,.10)!important;color:#7be8ff!important;border:1px solid rgba(25,216,255,.28)!important;font-family:\'Poppins\',sans-serif!important;font-size:8px!important;padding:5px 10px!important;}\n'
+'.match-card{border-bottom:1px solid rgba(25,216,255,.10)!important;background:#061625!important;}\n'
+'.match-row{min-height:78px;padding:10px 14px!important;background:linear-gradient(90deg,rgba(8,30,50,.98),rgba(5,19,32,.98))!important;}\n'
+'.match-card.odd .match-row,.match-card.even .match-row{background:linear-gradient(90deg,rgba(8,30,50,.98),rgba(5,19,32,.98))!important;}\n'
+'.match-card:not(.open) .match-row:hover{background:linear-gradient(90deg,rgba(11,55,88,.96),rgba(7,31,52,.96))!important;}\n'
+'.match-card:not(.open) .match-row:hover .team-name,.match-card:not(.open) .match-row:hover .score-num,.match-card:not(.open) .match-row:hover .match-dt{color:inherit!important;text-shadow:inherit!important;}\n'
+'.team-side{gap:10px!important;}\n'
+'.box-image{width:46px!important;height:46px!important;border:1px solid rgba(25,216,255,.16);border-radius:50%;display:flex;align-items:center;justify-content:center;background:rgba(0,8,16,.32);}\n'
+'.box-image img.team-logo{width:36px!important;height:36px!important;}\n'
+'.match-row:hover .box-image img.team-logo{transform:scale(1.10)!important;filter:drop-shadow(0 0 12px rgba(25,216,255,.35))!important;}\n'
+'.team-name{font-family:\'Poppins\',sans-serif!important;font-size:clamp(10px,1.7vw,13px)!important;font-weight:800!important;color:#f7fbff!important;}\n'
+'.score-center{width:110px!important;background:linear-gradient(180deg,#0b2b49,#071b30);border:1px solid rgba(25,216,255,.18);border-radius:9px;padding:7px 5px!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.04);}\n'
+'.score-num{font-family:\'Poppins\',sans-serif!important;font-size:clamp(18px,3vw,25px)!important;letter-spacing:4px!important;color:#fff!important;text-shadow:0 0 12px rgba(25,216,255,.25)!important;margin-bottom:3px!important;}\n'
+'.match-dt{font-family:\'Poppins\',sans-serif!important;font-size:8px!important;color:#9bc5e3!important;line-height:1.35!important;}\n'
+'.chev svg{color:#36dfff!important;}\n'
+'.pred-inner{background:linear-gradient(180deg,#04101d,#020914)!important;border-top:1px solid rgba(25,216,255,.15)!important;padding:12px 14px!important;}\n'
+'.pred-col{background:rgba(7,29,49,.74)!important;border:1px solid rgba(25,216,255,.14)!important;border-radius:10px!important;padding:10px 7px!important;}\n'
+'.pred-col::before{height:2px!important;}\n'
+'.col-title{font-family:\'Poppins\',sans-serif!important;font-size:8px!important;color:#8ddfff!important;letter-spacing:.5px!important;margin-bottom:5px!important;}\n'
+'.col-answer{font-family:\'Poppins\',sans-serif!important;font-size:clamp(14px,2.3vw,18px)!important;color:#fff!important;text-shadow:none!important;}\n'
+'.col-note{font-family:\'Poppins\',sans-serif!important;font-size:8px!important;color:#8caac1!important;}\n'
+'@media(max-width:720px){.site-logo.hero-arena{height:190px;border-radius:18px!important}.hero-logo-zone{left:4%;width:40%}.hero-player-zone{left:61%;width:30%;height:90%}.hero-decor{display:none}.date-display::after{display:none}.date-display::before{font-size:7px;padding:5px 8px}.filter-wrap{grid-template-columns:1fr!important}.bm-card{width:278px!important}.score-center{width:84px!important}.box-image{width:40px!important;height:40px!important}.box-image img.team-logo{width:31px!important;height:31px!important}.league-crown{padding-left:12px!important}.match-row{padding:9px 10px!important}}\n'
+'@media(max-width:430px){.site-logo.hero-arena{height:155px}.hero-logo-zone{width:42%}.hero-player-zone{left:64%;width:32%;height:88%}.hero-arena .logo-main{max-width:180px!important}.date-display{min-height:48px!important;padding:0 10px!important}.date-display::before{max-width:100px;text-align:center}.date-text{font-size:9px!important}.marquee-wrap{height:40px!important}.marquee-wrap::before{padding:0 9px;font-size:7px}.bm-kicker{font-size:17px!important}.bm-card{width:252px!important;padding:11px!important}.bm-logo{width:48px!important;height:48px!important}.filter-wrap,.tap-hint,.league-block,.date-display,.marquee-wrap,.bm-section{width:96%!important}.team-name{font-size:9px!important}.score-center{width:72px!important}.score-num{font-size:17px!important;letter-spacing:2px!important}.pred-grid{gap:5px!important}}\n'
+'</style>\n'
+'\n'
...
+'\n'
+'<header class="site-logo hero-arena">\n'
+'  <span class="hero-light hero-light-a"></span>\n'
+'  <span class="hero-light hero-light-b"></span>\n'
+'  <span class="hero-light hero-light-c"></span>\n'
+'  <div class="hero-logo-zone"><img class="logo-main" src="'+SITE_LOGO+'" alt="'+SITE_NAME+'"/></div>\n'
+'  <div class="hero-player-zone"><span class="player-halo"></span><img class="mbappe-gif" src="'+MBAPPE_GIF+'" alt="Football Player"/></div>\n'
+'  <div class="hero-decor"><span></span><span></span><span></span></div>\n'
+'</header>\n'
+'\n'
